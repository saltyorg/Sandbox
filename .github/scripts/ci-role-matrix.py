...
"""Build the role matrix used by Sandbox CI workflows."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Build the Sandbox CI role matrix.")
    parser.add_argument("--playbook", type=Path, default=Path("sandbox.yml"))
    parser.add_argument(
        "--config",
        type=Path,
